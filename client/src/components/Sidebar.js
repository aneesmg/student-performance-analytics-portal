...
import {
  ...
  SchoolIcon, BarChartIcon, SettingsIcon, BellIcon,
} from './Icons';
import './Sidebar.css';
...
const studentMenu = [
  ...
  { path: '/student/notifications', label: 'Notifications', icon: BellIcon },
...
const teacherMenu = [
  ...
  { path: '/teacher/notifications', label: 'Notifications', icon: BellIcon },
